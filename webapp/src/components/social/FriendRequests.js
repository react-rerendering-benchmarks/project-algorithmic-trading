...
import "./user.css";
import "./search.css";
export default memo(function FriendRequests() {
  ...
  return <div className="search">
      ...
      <div className="friends">
        ...
        <div className="requests-container">
          {requests.map((item, index) => <div className="user-display">
              <p>{item.username}</p>
              <div className="accept-decline-container">
                <button onClick={() => respondRequest(index, item.user_id, true)}>
                  Accept
                </button>
                <button onClick={() => respondRequest(index, item.user_id, false)}>
                  Decline
                </button>
              </div>
            </div>)}
